...
export default function Sections() {
  ...
  return (
    <div className="flex flex-row md:flex-col lg:flex-coltext-lg md:text-5xl lg:text-8xl font-barlow justify-center md:justify-normal lg:justify-normal [&>*]:transition-colors">
